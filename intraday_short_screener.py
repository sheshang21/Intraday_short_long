...
def show_intraday_short_screener():
    ...
    with st.expander("Technical Indicators & Trading Settings"):
        ...
        with col2:
            ...
            max_workers = st.number_input("Bulk Download Chunk Workers", min_value=1, max_value=6, value=3, step=1,
        ...
        force_fresh = st.checkbox(
            "🔄 Force fresh data this scan (recommended)", value=True, key="short_force_fresh",
