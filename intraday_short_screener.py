...
def show_intraday_short_screener():
    ...
    with st.expander("Technical Indicators & Trading Settings"):
        ...
        with col2:
            ...
            max_workers = st.number_input("Bulk Download Chunk Workers", min_value=1, max_value=2, value=2, step=1,
        ...
        force_fresh = st.checkbox(
            "🔄 Force fresh data this scan", value=False, key="short_force_fresh",
        ...
        if not results:
            ...
            if diag:
                ...
                st.caption(
                    ...
                    f"{diag['filtered_out']} had data but didn't meet the sell conditions · "
